...
class Auth extends Entity {
	...
	factory Auth.fromServer(final Map<String, dynamic> map) {
		...
		return Auth(
			...
			map['Admin'] != 0 ? true : false, userID != null ? DaoFactory.instance.userDao.get(map['UserID'])! : null
		);
	}
	...
	factory Auth.exp(int id, String username, String password, bool admin, int? userID) {
		...
		return Auth(id, username, password_hash, salt, admin, userID != null ? DaoFactory.instance.userDao.get(userID) : null);
	}
